...
import com.example.spongebobgame.memory_game.presentation.memory_screen.components.BuildButtons
import com.example.spongebobgame.memory_game.presentation.memory_screen.components.IconButton
import com.example.spongebobgame.memory_game.presentation.memory_screen.components.MemoryGameCard
import com.example.spongebobgame.memory_game.presentation.util.calculateRowRanges
            ...
            if(isPortrait){
                Column(
                    ...
                    Row(
                        ...
                        BuildButtons(viewModel = viewModel, modifier = Modifier.weight(1f), navController = navController)
                    }
                }
            }else {
                Column(
